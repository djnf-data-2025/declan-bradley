...
## Key Idea
The Association of American Railroads requires that trains carrying certain loads of hazardous material, referred to as "key trains," travel no faster than 50 mph. An initial analysis of car and train tables, cross-referenced with snapshots of travel speed at each track sensor, has tentatively identified **9,605 instances of high risk cargoes traveling faster than 50 mph**, in violation of this requirement. (See collected data [here](https://github.com/djnf-data-2025/declan-bradley/blob/main/data/violating-trains.csv).)
